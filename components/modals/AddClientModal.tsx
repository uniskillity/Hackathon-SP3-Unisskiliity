  ...
  return (
    <Modal isOpen={true} onClose={onClose} title="Add New Client">
      <form onSubmit={handleSubmit} className="space-y-4 max-h-[70vh] overflow-y-auto pr-2">
        <h4 className="text-sm font-bold text-gray-600 border-b pb-2">Personal Information</h4>
        ...
        <h4 className="text-sm font-bold text-gray-600 border-b pb-2 pt-4">Optional Details</h4>
           ...
           <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div className="space-y-1 text-center">
                    ...
                    <div className="flex text-sm text-gray-600">
                        ...
                        <p className="pl-1">(CNIC, Scorecard, etc.)</p>
                    </div>
                </div>
           </div>
           {documents.length > 0 && (
