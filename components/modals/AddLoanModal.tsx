  ...
  return (
    <Modal isOpen={true} onClose={onClose} title={`New Loan for ${client.name}`}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
            <label htmlFor="type" className="input-label">Loan Type</label>
         ...
         <div>
            <label htmlFor="officer" className="input-label">Assigned Officer</label>
            <select id="officer" value={assignedOfficer} onChange={e => setAssignedOfficer(e.target.value)} className="select">
        ...
        { (recommendation || isFetchingRecommendation) && (
            <div className="alert alert-info">
                <div className="alert-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" /></svg>
                </div>
                <div>
                    <h4 className="alert-title">AI Recommendation</h4>
                    {isFetchingRecommendation ? 
                        <div className="flex items-center" style={{gap: '0.5rem'}}><Spinner size="sm" /><span >Analyzing...</span></div> 
                        : <p>{recommendation}</p>
                    }
                </div>
            </div>
